...
"""Client for Groq API with Llama 3.2 Vision"""
...
<div class="subtitle">Professional Browser Automation with AI Vision • Built for Northflank</div>
""")
# Settings Section
with gr.Row():
...
# Launch with proper configuration for Northflank
interface.launch(
server_name="0.0.0.0",
